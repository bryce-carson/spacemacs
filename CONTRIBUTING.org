...
You can consider reading only the section(s) relevant to your intentions, or
[[https://www.youtube.com/watch?v=OMS-3Jl05mE&feature=youtu.be&list=PLpr9V-R8ZxiCHMl2_dn1Fovcd34Oz45sua][watch a video on YouTube]]:

- Submitting or Reviewing Pull Requests (PRs) :: PRs affect changes in the
  repository if they're merged. They /could change anything/. They go through
  volunteer-based review and automated testing processes.

  Read some of the following according to the changes you're proposing or
  reviewing:
...
- [[#asking-for-help][Asking for Help]] :: when you need /advice on using Spacemacs/ and are about to
  open an issue to ask a question.

- [[#reporting-issues][Reporting Issues]] :: if you are about to open a new issue.

* TODO LICENSE, COPYING, etc.
Code contributed to the Spacemacs repository, or to the Spacemacs organization,
is held in common by utilizing the GNU General Public License, rather than
attributing the copyright to some second party like a non-profit or charitable
foundation.

Assets like graphics, documentation, configuration files, etc. are held in
common under licenses like the GNU Free Documentation License, or must be in the
public domain.

=CONTRIBUTING.org= (the source of the document you're reading) is partially
based on the [[https://github.com/rails/rails/blob/master/CONTRIBUTING.md][Rails Contribution guidelines]] and [[https://github.com/flycheck/flycheck/blob/master/doc/contributor/contributing.rst][Flycheck Contribution guidelines]].
At Mon 30 Jun 2025 01:59:15 AM MDT, Bryce Carson reorganized this file as part
of a project to improve the user experience of reading documentation, updating
Spacemacs (and its documentation), troublehsooting, contributing, and more.

 :space_invader: :water_buffalo:

* Table of Contents                     :TOC_5_gh:noexport:
- [[#license-copying-etc][LICENSE, COPYING, etc.]]
- [[#asking-for-help][Asking for help]]
- [[#reporting-issues][Reporting issues]]
- [[#contributing-banners-or-other-files-placed-within-assets][Contributing banners or other files placed within /assets]]
...
* TODO Contributing banners or other files placed within [[file:assets/][/assets]]
The banner on the Spacemacs home buffer is the Spacemacs logo (by default; the
buffer is called the startup buffer in some documentation). There are other
community-contributed images and ASCII art banners available in the directory
=core/banners/=. If you have some vector drawing or ASCII artwork skills you can
submit your artwork! You are free to choose a reasonable height size but the
width size should be around 75 characters.
...
*** Changelog entry
Add a short entry describing /your proposed change(s)/ under a suitable
subheading in [[https://github.com/syl20bnr/spacemacs/blob/develop/CHANGELOG.develop][CHANGELOG.develop]]. Guidelines are the style in previous entries
and [[#commit-messages][commit messages instructions]] as guidelines. You may append your real name or
GitHub username to the entry in parentheses (e.g. /(Example-Contributor)/).

Common entries like "fix typo" or "update hyperlink" must find their home under
a common heading. If an exiting entry describes your contributions do not add
another entry (e.g. "small documentation improvements", "fix typo", "update
hyperlink", etc.); instead, you may add your name to the existing list of
collaborators for such a contribution. Where you add your name is unimportant.

#+begin_example
#* Layer Changes
#** Emacs Lisp
- Add support for =debugger= and =edebug=, see tutorial in =README.org= file ~("bryce-carson" "syl20bnr")~.
#+end_example
